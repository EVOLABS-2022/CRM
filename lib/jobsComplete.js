...
// TEMP: hardcoded fallback so you're unblocked. Remove after env is fixed.
...
function resolveSpreadsheetId() {
  ...
  console.log(`[jobsComplete] Using spreadsheetId from ${
...
async function setJobComplete(jobId) {
  ...
  console.log(`[jobsComplete] Marking ${jobId} complete at ${statusA1}`);
