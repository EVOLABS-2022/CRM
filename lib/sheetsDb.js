...
async function updateClientChannel(clientId, channelId, messageId) {
  ...
  await api.spreadsheets.values.update({
    spreadsheetId: SPREADSHEET_ID,
    range: `Clients!F${rowNumber}:G${rowNumber}`,
    valueInputOption: 'RAW',
    requestBody: {
...
async function updateClient(clientId, updates) {
  ...
  await api.spreadsheets.values.update({
    spreadsheetId: SPREADSHEET_ID,
    range: `Clients!A${rowNumber}:J${rowNumber}`,
    valueInputOption: 'RAW',
    requestBody: {
      values: [row]
    }
...
async function initializeSheets() {
  ...
  const clientHeaders = [['ID', 'Code', 'Name', 'Contact Name', 'Contact Method', 'Channel ID', 'Card Message ID', 'Description', 'Notes', 'Created At']];
