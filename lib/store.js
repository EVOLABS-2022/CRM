...
function reload() {
  ...
  console.log('🔄 Store reloaded:', db.clients?.length || 0, 'clients,', db.jobs?.length || 0, 'jobs');
}
...
module.exports = { db, save, reload, createClient, createJob, nextJobId, nextClientId };